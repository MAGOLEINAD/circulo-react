export const Header = () => {
    return (
        ...
        <div className="msm:flex container justify-center place-items-end flex ">
           ...
           <h1 className="text-gray-100 text-3xl sm:text-5xl antialiased text-shadow-xl uppercase font-semibold absolute msm:mt-80 msm: mb-12 text-center msm:text-4xl ">Circulo Magico 
           <div className="text-2xl sm:text-4xl antialiased uppercase italic msm:mt-0 mt-3 text-red-800 msm:text-lg msm:font-medium msm:tracking-normal">Escuela de Magia e Ilusionismo</div></h1>
